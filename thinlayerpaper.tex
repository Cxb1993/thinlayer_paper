...
\begin{figure}[!h]
\begin{center}
\includegraphics[width=4.5truein]{IMAGES/buffercells.png}\label{bufcell}
...
Papers \cite{ , } are good references about the history and evolution of the method.
...
found in \cite{,}. As could be seen in these equations, the time material derivative of phi is related to the product of the 
...
% 
% \begin{figure}[H]
% \centerline{\includegraphics[scale=0.5]{tiny.jpg}}
...
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny0.jpg}
%                 \caption{T=0 sec}
%                 \label{fig:h1}
%         \end{subfigure}\\
%         \begin{subfigure}[H]{0.9\textwidth}
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny1.jpg}
%                 \caption{T=10 sec}
%                 \label{fig:h2}
%         \end{subfigure}\\
%         \begin{subfigure}[H]{0.9\textwidth}
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny3.jpg}
%                 \caption{T=30 sec}
%                 \label{fig:h3}
%         \end{subfigure}\\
%         \begin{subfigure}[H]{0.9\textwidth}
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny6.jpg}
%                 \caption{T=60 sec}
%                 \label{fig:h3}
%         \end{subfigure}\\
%         \begin{subfigure}[H]{0.9\textwidth}
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny12.jpg}
%                 \caption{T=120 sec}
%                 \label{fig:h3}
%         \end{subfigure}\\
%         \begin{subfigure}[H]{0.9\textwidth}
%                 \includegraphics[width=\textwidth]{IMAGES/pics/tiny36.jpg}
%                 \caption{T=360 sec}
%                 \label{fig:h3}
%         \end{subfigure}\\
%                 
%         \caption{The interface position of the flow at differet time steps}\label{fig:tiny}
% \end{figure}
...
% \end{figure}
% \begin{figure}[H]
% \centerline{\includegraphics[width=.8\textwidth]{IMAGES/pics/level36.jpg}}
% \caption{T=360 s}
% \label{geoflow_interface}
% \end{figure}
...
%                 \label{fig:h3}
%         \end{subfigure}
%         \caption{Pictures of animals}\label{fig:tiny}
% \end{figure}
